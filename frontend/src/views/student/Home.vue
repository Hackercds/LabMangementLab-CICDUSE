  ...
  <div class="main-layout">
    <div class="sidebar">
      ...
      >
        ...
        <el-menu-item index="/student/my-reservation">
          <el-icon><Document /></el-icon>
          <span>我的预约</span>
        </el-menu-item>
        <el-menu-item index="/student/device">
          <el-icon><Monitor /></el-icon>
          <span>设备查询</span>
        </el-menu-item>
        <el-menu-item index="/student/consumable">
          <el-icon><Box /></el-icon>
          <span>耗材领用</span>
        </el-menu-item>
...
<script setup>
import { Calendar, Document, Monitor, Box, User } from '@element-plus/icons-vue'
